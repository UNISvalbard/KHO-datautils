...
def oneThumbnail(imagefile,overWriteExisting=False):
    ...
    filepattern=r"LYR-D80-(\d\d)(\d\d)(\d\d)_(\d\d)(\d\d)(\d\d).jpg"
    ...
    auroraXname=f'LYR-D80-{fileyear}{filemonth:02}{fileday:02}_{filehh:02}{filemm:02}{filess:02}.jpg'
    ...
    with Image.open(imagefile).resize((480,480)) as im:
        ...
        d.text((5,30),"Nikon D80", font=font1, fill=(255,255,255))
